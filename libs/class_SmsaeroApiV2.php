...
class SmsaeroApiV2
{
    ...
    private $email = 'Kamranltd@yandex.ru'; //Ваш логин|email
    private $api_key = 'WB7RmbKlTu2VJq6GbpD6e9LIbfWf'; //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
    private $sign = 'LABUTON'; //Подпись по умолчанию
     ...
     * @return array
     */
    public function viber_send($number, $groupId, $sign, $channel, $text, $imageSource = null, $textButton = null,
