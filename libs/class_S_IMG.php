...
class S_IMG
{
     ...
     */
    public function fromString(string $string): classSimpleImage|static
    {
     ...
     *
     * @param  string|classSimpleImage  $overlay The image to overlay. This can be a filename, a data URI, or a SimpleImage object.
     ...
     * @throws Exception
     */
    public function overlay(string|classSimpleImage $overlay, string $anchor = 'center', float|int $opacity = 1, int $xOffset = 0, int $yOffset = 0, bool $calculateOffsetFromEdge = false): static
    {
        // Load overlay image
        if (! ($overlay instanceof classSimpleImage)) {
            $overlay = new classSimpleImage($overlay);
        }
    ...
    public function textBox(string $text, array $options): static
    {
        ...
        $imageText = new classSimpleImage();
     ...
     * @return classSimpleImage
     */
    public function thumbnail(int $width, int $height, string $anchor = 'center'): classSimpleImage|static
    {
    ...
    public function arc(int $x, int $y, int $width, int $height, int $start, int $end, string|array $color, int|string $thickness = 1): static
    {
        ...
        if ($thickness === 'filled') {
            ...
            // New temp image
            $tempImage = new classSimpleImage();
